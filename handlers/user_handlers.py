...
from keyboards.bookmarks_kb import (creat_edit_keyboard,
                                    creat_bookmarks_keyboard)
...
async def process_bookmarks_command(message: Message):
    if users_db[message.from_user.id]['bookmarks']:
        await message.answer(
            ...
            reply_markup=creat_bookmarks_keyboard(
...
async def process_edit_press(callback: CallbackQuery):
    await callback.message.edit_text(
        ...
        reply_markup=creat_edit_keyboard(
            *users_db[callback.from_user.id]["bookmarks"]))
    await callback.answer()


async def process_cancel_press(callback: CallbackQuery):
    await callback.answer(text=LEXICON['cancel_text'])
    await callback.answer()
...
def register_user_handlers(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(process_bookmark_press,
    ...
    dp.register_callback_query_handler(process_del_press,
